...
define your personal variables in ./group_vars/: 
#+BEGIN_SRC yaml :tangle group_vars/localhost_dist.yml
###
### Complete Computing Environment Personal variables
###
...
** ansible
#+BEGIN_SRC yaml :tangle tasks/python.yaml :mkdirp yes
